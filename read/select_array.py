...
# https://docs.oracle.com/en/database/other-databases/nosql-database/18.1/sqlfornosql/working-arrays.html
#
#
...
query = """
  ...
  SELECT * FROM produtos WHERE produtos.propriedades.Tamanho[] =any "38"
