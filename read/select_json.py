...
# https://docs.oracle.com/en/database/other-databases/nosql-database/18.1/sqlfornosql/working-json.html
#
#
...
query = """
  ...
  SELECT propriedades, valor FROM produtos WHERE produtos.propriedades.Cor = "Vermelho"
